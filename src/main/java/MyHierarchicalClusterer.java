...
//    public Vector<Integer>[] nClusterID;
//
//    @Override
...
//
//        nClusterID = new Vector[data.numInstances()];
...
//        List<Node> m_clusters_list = new ArrayList<Node>();
...
//                m_clusters_list.add(clusterNodes[i]);
//                iCurrent++;
//            }
//        }
//        m_clusters = m_clusters_list.toArray(new Node[0]);
//        m_nNumClusters = m_clusters.length;
//
//    } // buildClusterer
//
//    /**
...
//     * @param clusterNodes
//     */
//    protected void doLinkClustering(int nClusters, Vector<Integer>[] nClusterID,
//                                    Node[] clusterNodes) {
//        int nInstances = m_instances.numInstances();
